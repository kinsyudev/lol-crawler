...
impl Endpoints {
    pub fn featured_games(config: &Config, region: &str) -> String {
        format!("{}/lol/spectator/v4/featured-games", config.base_url_for_region(region))
    }
    ...
    pub fn match_list_by_puuid(config: &Config, region: &str, puuid: &str, start: Option<u32>, count: Option<u32>) -> String {
